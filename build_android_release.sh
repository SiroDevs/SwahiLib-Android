...
export JAVA_HOME="$(cd $DIR/../swahilib-prebuilts/jdk17/linux && pwd )"
...
cp $DIR/../swahilib-prebuilts/google-services.json $DIR/app

echo "Copying local.properties"
cp $DIR/../swahilib-prebuilts/local.properties $DIR
