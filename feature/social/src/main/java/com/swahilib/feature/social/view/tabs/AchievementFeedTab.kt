...
/** Postgres returns an ISO-8601 timestamp - rather than parsing it (a parse failure shouldn't
 * crash a list row), just take the date portion, which is always safe plain substring work. */
